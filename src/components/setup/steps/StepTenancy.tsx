...
export default function StepTenancy({ data, onChange, onNext, onBack }: Props) {
  return (
    <div>
      <h2 className="text-2xl font-bold text-white mb-2">Deployment Mode</h2>
      ...
      <div className="flex gap-3">
        <Button variant="outline" onClick={onBack} className="flex-1 border-slate-600 text-slate-300 hover:bg-slate-700">
          Back
        </Button>
