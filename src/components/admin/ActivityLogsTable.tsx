...
const SEVERITY_CONFIG = {
  INFO:     { icon: Info,          color: 'text-slate-400',  bg: 'bg-slate-700/50' },
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <select
          ...
          className="bg-slate-800 border border-slate-700 rounded-md px-3 py-2 text-sm text-slate-300 focus:outline-none focus:border-blue-500"
        >
      ...
      <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl overflow-hidden">
        <div className="grid grid-cols-[auto_1fr_auto_auto_auto] gap-0 text-xs text-slate-500 font-medium uppercase tracking-wider px-4 py-2.5 border-b border-slate-700/50">
          <span className="w-6" />
              ...
              return (
                <div key={log.id}>
                  <button
                    ...
                    className="w-full grid grid-cols-[auto_1fr_auto_auto_auto] gap-0 items-center px-4 py-3 hover:bg-slate-700/20 transition-colors text-left"
                  >
                    ...
                    <div className="px-4">
                      {log.entityType && (
                        <Badge className="text-xs bg-slate-700 text-slate-400 border-0">
                          {log.entityType}
                        </Badge>
                      )}
                    </div>
                  ...
                  {isExpanded && log.details && (
                    <div className="px-4 pb-3 ml-9">
                      <pre className="text-xs text-slate-400 bg-slate-900 rounded-lg p-3 overflow-x-auto max-h-48">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="border-slate-700 text-slate-400 hover:bg-slate-700 h-7 w-7 p-0"
          >
